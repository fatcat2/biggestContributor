...
def default_route():
    ...
    return render_template(
        "index.html", sub="Purdue", results=subreddit_results, limit=int(100)
    )
...
def results_route():
    ...
    return render_template(
        "index.html", sub=sub_name, results=subreddit_results, limit=int(limit_num)
    )
